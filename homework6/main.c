...
static int __ref kernel_init(void *unused)
{
	...
	/*********************************************************************************
	 * calling the functions that will create threads
	 ********************************************************************************/

	print_info_of_all_task();
	printk(KERN_NOTICE "%s: m_k_t_do_something threads are about to be created.\n", OH_MY_NAME);
	my_kernel_thread_create_1();
	my_kernel_thread_create_2();
	printk(KERN_NOTICE "%s: m_k_t_do_something threads are created.\n", OH_MY_NAME);
	print_info_of_all_task();
